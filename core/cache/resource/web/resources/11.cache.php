    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center mb-4">
            <h1 class="mb-2 bread">Transfer</h1>
            <p class="breadcrumbs" style="padding-bottom: 20px;"><span class="mr-2"><a href="[[~1]]">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Transfer<i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
    </div>
</section>
...
<section class="about-section">
	...
	<!--Content Column-->
	<div class="content-column col-md-6 col-sm-12 col-xs-12 align-items-center d-flex">
		<div class="inner-column">
			<div class="sec-title">
				<h2 style="font-size: 30px; color: #a40000; font-weight: bold;">Enjoy a Smooth Journey</h2>
			</div>
			<div class="text" style="text-align: justify;">
				Enhance your Sri Lankan experience with SR Rent A Car\'s premium chauffeur-driven airport and hotel transfers. Our fleet of luxurious vehicles, coupled with our professional and experienced chauffeurs, ensures a comfortable and stylish travel experience.
			</div>
			<div class="text" style="text-align: justify;">
				From the moment you land at Colombo International Airport (CMB), our Meet and Greet service welcomes you with a warm and efficient reception. Our drivers will escort you to your chosen vehicle and assist you throughout your journey.
			</div>
			<div class="text" style="text-align: justify;">
				Whether you\'re heading to your hotel or embarking on a sightseeing adventure, our reliable and punctual transfer services provide the freedom and convenience you need. Book your airport transfer with SR Rent A Car today and experience the difference.
			</div>
						
	
			<a href="https://srilankatransfer.lk/booking.html" target = "_blank"class="theme-btn btn-style-three">Book a Transfer</a>
		</div>
	</div>
	<!--Image Column-->
	<div class="image-column col-md-6 col-sm-12 col-xs-12">
		<div class="inner-column " data-wow-delay="0ms" data-wow-duration="1500ms">
			<div class="image">
				<img src="assets/images/wedding/transfer.jpg" alt="">
...
<section class="transfer-section">
	<div class="container">
		...
		<span class="transfer-subtitle">Transfers</span>
		<h2 class="transfer-title">Our Transfer Services</h2>
		<p class="transfer-lead">
			Chauffeur-driven Airport Transfers and Hotel Transfers across Sri Lanka — including Colombo International Airport (CMB) and all hotels islandwide.
		</p>
		</div>

		<!-- Top highlight cards -->
		<div class="row g-4 transfer-highlights">
		<div class="col-12 col-lg-6">
			...
			<div class="th-content">
				...
				<p>
				Arrive in style and comfort with our 24/7 private airport transfer service.
				Your chauffeur greets you at Bandaranaike International Airport (CMB) with a personalized sign
				and escorts you directly to your destination.
				</p>
			</div>
			</div>
		</div>
		...
		<div class="col-12 col-lg-6">
			...
			<div class="th-icon">🏨</div>
			<div class="th-content">
				<h4>Hassle-Free Hotel Transfers</h4>
				<p>
				Already in Sri Lanka? Book a hotel transfer and enjoy a smooth ride to your next destination.
				Your chauffeur picks you up right from your hotel doorstep.
				</p>
			</div>
			</div>
		</div>
		...
		<h3 class="transfer-info-title">Luxury Chauffeur Service, 24/7 Support</h3>
		<p>
			SR Rent A Car offers chauffeur-driven Airport Transfers and Hotel Transfers in Sri Lanka. We offer our service for
			Colombo International Airport (CMB) & all hotels in Sri Lanka. Our helpful chauffeurs and luxury fleet ensure a professional
			service. Our well-maintained vehicle categories let you choose the right option for your journey. You can contact our helpful
			staff members 24/7 to clarify any information.
		</p>
		<p>
			We provide efficient and reliable airport transfers in Sri Lanka and take pride in our Meet & Greet service at CMB.
			On arrival, you will meet one of our professional and experienced chauffeurs. He’ll escort you to your car and assist you
			throughout your journey.
		</p>
		<p>
			SR Rent A Car provides a stylish and comfortable journey without relying on public transport and gives you flexibility to explore places
			of your choice right from the airport. A single phone call or email will have your transfer vehicle ready. If you’re looking for reliable
			chauffeur service in safety, comfort and style, book your airport car rental with SR Rent A Car today.
		</p>
		</div>
		...
		<div class="col-12 col-lg-6">
			...
			<div class="transfer-card-head">
				<div class="tc-badge">Airport</div>
				<h3>Airport Transfers</h3>
			</div>

			<p>
				SR Transfers can arrange airport transfers from Bandaranaike International Airport (Colombo Airport [CMB])
				to many destinations in Sri Lanka. We provide a 24/7 private airport transfer service catering to all your requirements.
				Your chauffeur will greet you at the arrival lobby with a paging board showing your name.
			</p>

			<div class="transfer-actions">
				<a class="transfer-btn" href="tel:+94773207108">Call (+94) 773 207 108</a>
				<a class="transfer-link" href="#">Get a Quote →</a>
			</div>
			</div>
		</div>
		...
		<div class="col-12 col-lg-6">
			<div class="transfer-card">
			<div class="transfer-card-head">
				<div class="tc-badge">Hotel</div>
				<h3>Hotel Transfers</h3>
			</div>

			<p>
				If you are already in the country and need secure transportation to move among destinations, you can book a transfer
				from SR Transfers. We’ll send a chauffeur-driven vehicle to your hotel doorstep to pick you up.
			</p>
...
<section class="transfer-features">
  <div class="container">
    ...
    <div class="text-center mb-5">
      <span class="tf-sub">Why Choose Us</span>
      <h2 class="tf-title">Premium Transfer Experience</h2>
      <p class="tf-lead">
        We combine professionalism, safety, and reliability to deliver a seamless
        chauffeur-driven experience across Sri Lanka.
      </p>
    </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-12 col-sm-6 col-lg-4">
        <div class="tf-card">
          <div class="tf-icon"><i class="fas fa-briefcase"></i></div>
          <h4>Highly Professional Services</h4>
          <p>
            We provide exceptional private transfer services for visitors arriving
            or departing Sri Lanka. Fast, reliable, comfortable, and convenient.
          </p>
        </div>
      </div>
      ...
      <div class="col-12 col-sm-6 col-lg-4">
        <div class="tf-card">
          <div class="tf-icon"><i class="fas fa-star"></i></div>
          <h4>Quality Customer Services</h4>
          <p>
            Customer satisfaction is our priority. We ensure a smooth,
            comfortable and stress-free experience tailored to your needs.
          </p>
        </div>
      </div>
      ...
      <div class="col-12 col-sm-6 col-lg-4">
        <div class="tf-card">
          <div class="tf-icon"><i class="fas fa-clock"></i></div>
          <h4>Reliable & Punctual</h4>
          <p>
            We monitor flight arrivals to ensure timely pickups. Our services
            are prompt, punctual, and dependable.
          </p>
        </div>
      </div>
      ...
      <div class="col-12 col-sm-6 col-lg-4 mt-4">
        <div class="tf-card">
          <div class="tf-icon"><i class="fas fa-users"></i></div>
          <h4>Well-Trained Team</h4>
          <p>
            Our professional drivers have extensive knowledge of Colombo and
            major cities, ensuring a smooth and enjoyable journey.
          </p>
        </div>
      </div>
      ...
      <div class="col-12 col-sm-6 col-lg-4 mt-4">
        <div class="tf-card">
          <div class="tf-icon"><i class="fas fa-shield-alt"></i></div>
          <h4>High Safety Standards</h4>
          <p>
            We maintain secure, well-serviced vehicles and experienced drivers
            to guarantee maximum safety and comfort.
          </p>
        </div>
      </div>
      ...
      <div class="col-12 col-sm-6 col-lg-4 mt-4">
        <div class="tf-card">
          <div class="tf-icon"><i class="fas fa-headset"></i></div>
          <h4>24/7 Availability</h4>
          <p>
            Our transfer services operate around the clock — including weekends
            and public holidays.
          </p>
        </div>
      </div>
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1725626063,
    'editedby' => 1,
    'editedon' => 1772517776,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1725626040,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<section class="hero-wrap hero-wrap-2" style="background-image: url(\'assets/images/breadcrumb/sr_bc_rentacar.jpg\');" data-stellar-background-ratio="0.5">
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center mb-4">
            <h1 class="mb-2 bread">Transfer</h1>
            <p class="breadcrumbs" style="padding-bottom: 20px;"><span class="mr-2"><a href="index.php?id=1">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Transfer<i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
    </div>
</section>
