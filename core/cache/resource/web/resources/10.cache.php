        ...
        <div class="container">
          <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate text-center mb-4">
              ...
              <p class="breadcrumbs" style="padding-bottom: 20px;"><span class="mr-2"><a href="[[~1]]">Home <i class="ion-ios-arrow-forward"></i></a></span> <span> FREQUENTLY ASKED QUESTIONS<i class="ion-ios-arrow-forward"></i></span></p>
            </div>
          </div>
        </div>
      </section>
                            ...
                            <div class="accordion" id="accordion-tab-1">
                                <div class="card">
                                    ...
                                    <div class="collapse" id="accordion-tab-1-content-1" aria-labelledby="accordion-tab-1-heading-1" data-parent="#accordion-tab-1">
                                      <div class="faq-body">
                                        <p>
                                            You must have the following documents with you in order to rent a car. 
                                        
                                            A valid passport.
                                            A valid international driving licence.
                                            A valid temporary local (Sri Lankan) driving licence.
                                            Valid working credit card.
                                        </p>
                                      </div>
                                    </div>
                                  </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="accordion-tab-1-heading-2">
                                        <h5>
                                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#accordion-tab-1-content-2" aria-expanded="false" aria-controls="accordion-tab-1-content-2">What type of driver\'s license do I need to drive in Sri Lanka?</button>
                                        </h5>
                                    </div>
                                    <div class="collapse" id="accordion-tab-1-content-2" aria-labelledby="accordion-tab-1-heading-2" data-parent="#accordion-tab-1">
                                        <div class="faq-body">
                                            <p>
                                                You’ll need a valid International Driving Permit issued by a competent government institution that conforms to the format specified by the Geneva Convention on Road Traffic 1949.
                                                You’ll also need to obtain a Temporary Sri Lanka Driving Permit (TDL).
                                                    Now it is COMPULSORY to obtain a TDL for every foreigner to drive a vehicle in Sri Lanka.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header" id="accordion-tab-1-heading-3">
                                        <h5>
                                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#accordion-tab-1-content-3" aria-expanded="false" aria-controls="accordion-tab-1-content-3">How can I obtain a temporary driving license (TDL) in Sri Lanka?</button>
                                        </h5>
                                    </div>
                                    <div class="collapse" id="accordion-tab-1-content-3" aria-labelledby="accordion-tab-1-heading-3" data-parent="#accordion-tab-1">
                                        <div class="faq-body">
                                            <p>
                                                ...
                                                You can obtain it yourself when you are in Sri Lanka. (It can not be done online & your only option will be by visiting the Sri Lanka Motor Trafic Department)
                                                We can obtain it on behalf of you. You just need to mention that you need a TDL when you request a quote.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header" id="accordion-tab-1-heading-4">
                                        <h5>
                                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#accordion-tab-1-content-4" aria-expanded="false" aria-controls="accordion-tab-1-content-4">Can elderly people also rent cars?</button>
                                        </h5>
                                    </div>
                                    <div class="collapse" id="accordion-tab-1-content-4" aria-labelledby="accordion-tab-1-heading-4" data-parent="#accordion-tab-1">
                                        <div class="faq-body">
                                            <p>Yes. No age restrictions are in place. Anybody with a valid driver’s license can rent a vehicle.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion" id="accordion-tab-2">
                                <div class="card">
                                    <div class="card-header" id="accordion-tab-2-heading-1">
                                        <h5>
                                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#accordion-tab-2-content-1" aria-expanded="false" aria-controls="accordion-tab-2-content-1">What is included in the rental price, and are there any additional fees?</button>
                                        </h5>
                                    </div>
                                    <div class="collapse " id="accordion-tab-2-content-1" aria-labelledby="accordion-tab-2-heading-1" data-parent="#accordion-tab-2">
                                        <div class="faq-body">
                                            <p style="text-align: justify;">
                                                The basic rental price typically covers the vehicle and standard insurance. 
                                                However, there are several additional optional services and fees that customers may choose based on their needs. These may include:
                                            </p>
                                            <ul style="padding-left: 20px;">
                                                <li>Unlimited mileage or mileage restrictions</li>
                                                <li>Additional driver fees</li>
                                                <li>Baby seat rental</li>
                                                <li>Additional navigation systems</li>
                                                <li>Fuel charges (full-to-full or prepaid fuel options)</li>
                                                <li>Optional insurance upgrades</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header" id="accordion-tab-2-heading-2">
                                        <h5>
                                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#accordion-tab-2-content-2" aria-expanded="false" aria-controls="accordion-tab-2-content-2">Can I drop off the car at a different location from where I picked it up?</button>
                                        </h5>
                                    </div>
                                    <div class="collapse" id="accordion-tab-2-content-2" aria-labelledby="accordion-tab-2-heading-2" data-parent="#accordion-tab-2">
                                        <div class="faq-body">
                                            <p style="text-align: justify;">One-way rentals are possible but typically incur an additional fee. Our rental staff will conduct a thorough vehicle inspection at the collection point to ensure the condition of the vehicle before finalizing the rental agreement.</p>
                                ...
                                <div class="card">
                                    <div class="card-header" id="accordion-tab-2-heading-3">
                                        <h5>
                                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#accordion-tab-2-content-3" aria-expanded="false" aria-controls="accordion-tab-2-content-3">What happens if I need to cancel my reservation?</button>
                                        </h5>
                                    </div>
                                    <div class="collapse" id="accordion-tab-2-content-3" aria-labelledby="accordion-tab-2-heading-3" data-parent="#accordion-tab-2">
                                        <div class="faq-body">
                                            <p style="text-align: justify;">Cancellation policies vary depending on the type of reservation and how close it is to the pickup date. </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header" id="accordion-tab-2-heading-4">
                                        <h5>
                                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#accordion-tab-2-content-4" aria-expanded="false" aria-controls="accordion-tab-2-content-4">Can I modify my existing reservation?</button>
                                        </h5>
                                    </div>
                                    <div class="collapse" id="accordion-tab-2-content-4" aria-labelledby="accordion-tab-2-heading-4" data-parent="#accordion-tab-2">
                                        <div class="faq-body">
                                            <p style="text-align: justify;">Reservation modifications are possible, preferably with at least 24 hours\' notice. Changes can even be made at the collection point, subject to vehicle availability. </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header" id="accordion-tab-2-heading-5">
                                        <h5>
                                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#accordion-tab-2-content-4" aria-expanded="false" aria-controls="accordion-tab-2-content-4">How much will it cost to modify a reservation?</button>
                                        </h5>
                                    </div>
                                    <div class="collapse" id="accordion-tab-2-content-4" aria-labelledby="accordion-tab-2-heading-4" data-parent="#accordion-tab-2">
                                        <div class="faq-body">
                                            <p style="text-align: justify;">Modification costs vary depending on the vehicle model you select. We offer flexible charge policies for reservation changes, ensuring you have the most convenient rental experience possible. </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="accordion" id="accordion-tab-3">
                                <div class="card">
                                    <div class="card-header" id="accordion-tab-3-heading-1">
                                        <h5>
                                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#accordion-tab-3-content-1" aria-expanded="false" aria-controls="accordion-tab-3-content-1">What should I do if I damage the car?</button>
                                        </h5>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="accordion-tab-3-heading-2">
                                        <h5>
                                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#accordion-tab-3-content-2" aria-expanded="false" aria-controls="accordion-tab-3-content-2">What should I do in case of an accident or theft while renting a car?</button>
                                        </h5>
                                    </div>
                                    <div class="collapse" id="accordion-tab-3-content-2" aria-labelledby="accordion-tab-3-heading-2" data-parent="#accordion-tab-3">
                                        <div class="faq-body">
                                            <p>
                                                ...
                                                In the occurrence of a theft, please report it to the police and the office.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header" id="accordion-tab-3-heading-3">
                                        <h5>
                                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#accordion-tab-3-content-3" aria-expanded="false" aria-controls="accordion-tab-3-content-3">Are there any restrictions on mileage when using a rental car?</button>
                                        </h5>
                                    </div>
                                    <div class="collapse" id="accordion-tab-3-content-3" aria-labelledby="accordion-tab-3-heading-3" data-parent="#accordion-tab-3">
                                        <div class="faq-body">
                                            <p>Yes, You can travel only 100km per day or 3000km per month (if you are renting for a month). Extra mileage will be charged based on vehicle category.</p>
                                ...
                                <div class="card">
                                    <div class="card-header" id="accordion-tab-3-heading-4">
                                        <h5>
                                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#accordion-tab-3-content-4" aria-expanded="false" aria-controls="accordion-tab-3-content-4">Can my pet ride in the car?</button>
                                        </h5>
                                    </div>
                                    <div class="collapse" id="accordion-tab-3-content-4" aria-labelledby="accordion-tab-3-heading-4" data-parent="#accordion-tab-3">
                                        <div class="faq-body">
                                            <p>No. Pets aren’t allowed to be taken on your rental vehicle. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion" id="accordion-tab-4">
                                <div class="card">
                                    <div class="card-header" id="accordion-tab-4-heading-1">
                                        <h5>
                                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#accordion-tab-4-content-1" aria-expanded="false" aria-controls="accordion-tab-4-content-1">What do I need to bring when picking up the car?</button>
                                        </h5>
                                    </div>
                                    <div class="collapse " id="accordion-tab-4-content-1" aria-labelledby="accordion-tab-4-heading-1" data-parent="#accordion-tab-4">
                                        <div class="faq-body">
                                            <p>
                                                Your passport.
                                                Your International Diving Licence.
                                                Your Sri Lanka Temporary Driving Licence. (If you don’t have one we can arrange one for you)
                                                Your Credit Card 
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="accordion-tab-4-heading-3">
                                        <h5>
                                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#accordion-tab-4-content-3" aria-expanded="false" aria-controls="accordion-tab-4-content-3">Can I make changes to the reservation when I pick up the car?</button>
                                        </h5>
                                    </div>
                                    <div class="collapse" id="accordion-tab-4-content-3" aria-labelledby="accordion-tab-4-heading-3" data-parent="#accordion-tab-4">
                                        <div class="faq-body">
                                            <p>Yes, you can make changes to your reservation at the pickup. Things such as the rental period can be easily be changed. But your selected vehicle category & extras are subject to availability. </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header" id="accordion-tab-4-heading-4">
                                        <h5>
                                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#accordion-tab-4-content-4" aria-expanded="false" aria-controls="accordion-tab-4-content-4">Can I arrange for the car to be delivered to the airport?</button>
                                        </h5>
                                    </div>
                                    <div class="collapse" id="accordion-tab-4-content-4" aria-labelledby="accordion-tab-4-heading-4" data-parent="#accordion-tab-4">
                                        <div class="faq-body">
                                            <p>Yes, you can pick up your requested vehicle from the airport.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
',
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1725602972,
    'editedby' => 1,
    'editedon' => 1748924191,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1725602940,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url(\'assets/images/home/breadcrumb.jpg\');" data-stellar-background-ratio="0.5">
        ...
        <div class="container">
          <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate text-center mb-4">
              <h1 class="mb-2 bread">FAQ</h1>
              <p class="breadcrumbs" style="padding-bottom: 20px;"><span class="mr-2"><a href="index.php?id=1">Home <i class="ion-ios-arrow-forward"></i></a></span> <span> FREQUENTLY ASKED QUESTIONS<i class="ion-ios-arrow-forward"></i></span></p>
            </div>
          </div>
        </div>
      </section>
