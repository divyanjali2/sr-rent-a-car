...
<!-- <section class="offers-section">
  <div class="container">
    ...
    <div class="offers-head">
      <div>
        <span class="offers-kicker">Promotions</span>
        <h2 class="offers-title">Latest Offers & Deals</h2>
        <p class="offers-sub">
          Save more on rentals, airport transfers, and long-term hires. Limited-time deals updated regularly.
        </p>
      </div>

      <a href="[[~5]]" class="offers-viewall">View All Offers →</a>
    </div>
    ...
    <div class="offers-grid">
      ...
      <article class="offer-card">
        <div class="offer-top">
          <span class="offer-tag hot">HOT DEAL</span>
          <span class="offer-type">Self Drive</span>
        </div>

        <h3 class="offer-name">Weekend Saver</h3>
        <p class="offer-desc">Get up to <strong>25% off</strong> mini & economy cars for Fri–Sun bookings.</p>

        <div class="offer-meta">
          <div class="offer-pill">Min 2 days</div>
          <div class="offer-pill">Free cancellation*</div>
        </div>

        <div class="offer-coupon">
          <span>Use Code</span>
          <button class="coupon-btn" type="button" data-copy="WEEKEND25">WEEKEND25</button>
        </div>

        <a class="offer-cta" href="[[~9]]">Book Rental →</a>
      </article>

      <article class="offer-card">
        <div class="offer-top">
          <span class="offer-tag green">BEST VALUE</span>
          <span class="offer-type">Airport Transfer</span>
        </div>

        <h3 class="offer-name">CMB Pickup Deal</h3>
        <p class="offer-desc">Flat <strong>20% off</strong> chauffeur-driven transfers from Colombo Airport.</p>

        <div class="offer-meta">
          <div class="offer-pill">Meet & greet</div>
          <div class="offer-pill">24/7 service</div>
        </div>

        <div class="offer-coupon">
          <span>Use Code</span>
          <button class="coupon-btn" type="button" data-copy="CMB20">CMB20</button>
        </div>

        <a class="offer-cta" href="[[~30]]">Get Quote →</a>
      </article>

      <article class="offer-card">
        <div class="offer-top">
          <span class="offer-tag blue">LONG TERM</span>
          <span class="offer-type">Monthly Hire</span>
        </div>

        <h3 class="offer-name">30+ Days Discount</h3>
        <p class="offer-desc">Save more with long-term rentals. Best rates for <strong>30–90 days</strong>.</p>

        <div class="offer-meta">
          <div class="offer-pill">Custom pricing</div>
          <div class="offer-pill">Support included</div>
        </div>

        <div class="offer-coupon">
          <span>Use Code</span>
          <button class="coupon-btn" type="button" data-copy="MONTHLY10">MONTHLY10</button>
        </div>

        <a class="offer-cta" href="[[~9]]">Request Offer →</a>
      </article>

    </div>

    <p class="offers-note">
      *Free cancellation terms apply. Offers may change based on availability.
    </p>
      ...
      <article class="promo50-card">
        ...
        <div class="promo50-overlay">
          <div class="promo50-content">
            <div class="promo50-title">50%<br>OFF</div>
            <div class="promo50-sub">Clean. Safe. Reliable.</div>
            <a href="index.php?id=9" class="promo50-btn">Book Now</a>
          </div>
        </div>
      </article>
      ...
      <article class="promo50-card">
        ...
        <div class="promo50-overlay">
          <div class="promo50-content">
            <div class="promo50-title">50%<br>OFF</div>
            <div class="promo50-sub">Limited time deal.</div>
            <a href="index.php?id=30" class="promo50-btn">Get Quote</a>
          </div>
        </div>
      </article>
...
<!-- <section class="offers-section">
  <div class="container">
    ...
    <div class="offers-head">
      ...
      <a href="index.php?id=5" class="offers-viewall">View All Offers →</a>
    </div>
    ...
    <div class="offers-grid">
      ...
      <article class="offer-card">
        ...
        <a class="offer-cta" href="index.php?id=9">Book Rental →</a>
      </article>
      ...
      <article class="offer-card">
        ...
        <a class="offer-cta" href="index.php?id=30">Get Quote →</a>
      </article>
      ...
      <article class="offer-card">
        ...
        <a class="offer-cta" href="index.php?id=9">Request Offer →</a>
      </article>
